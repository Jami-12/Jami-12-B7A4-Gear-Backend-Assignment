...
-- CreateEnum
CREATE TYPE "GearStatus" AS ENUM ('AVAILABLE', 'OUT_OF_STOCK', 'RENTED');
...
CREATE TABLE "rental_orders" (
    ...
    "customerId" TEXT NOT NULL,
    "rentalStatus" "RentalStatus" NOT NULL DEFAULT 'PLACED',
...
-- AddForeignKey
ALTER TABLE "gear_items" ADD CONSTRAINT "gear_items_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
